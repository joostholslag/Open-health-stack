...
#
# ⚠ These live in terraform.tfstate in plaintext. State lives in the remote
#   Scaleway Object Storage backend (see versions.tf) — anyone who can read
#   that bucket has every password.
output "credentials" {
