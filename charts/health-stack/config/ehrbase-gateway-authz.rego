# Authorization policy for the EHRbase PEP gateway sidecar container.
#
...
#
# Kept identical to docker/opa/policies/ehrbase/authz.rego (the compose-layer
# version, where the gateway/opa/backend are three separate containers rather
# than sidecars in one Pod) — the input shape doesn't change with topology.
